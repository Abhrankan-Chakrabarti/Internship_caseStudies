...
//     console.log("The double of the given number is "+num*2);
//     return num*2;
// }

// printdouble(5);

// function printfruit(fruit : string){
...
// let a:string = '123';
// var b:number = <number><any>a;
// console.log(typeof(a)+typeof(b));


// function processTransaction(amount: number,description:string,iscredit:boolean): void{
//     if(amount<0) throw new Error("Amount is -ve.");
//     if(description == null) throw new Error("Description ")
// }

// processTransaction(10,"null",true);
...
// let array:staff[] = [
//     {id:1,name:"Aryan",role:Role.Doctor},
//     {id:2,name:"Aman",role:Role.Nurse},
//     {id:3,name:"Arnav",role:Role.Admin},
// ];

// function printsummary(arr:staff[]):void{
//     for(let i = 0; i< arr.length;i++){
//         console.log("id: ",arr[i].id);
//         console.log("Name: ",arr[i].name);
//         console.log("Role: ",Role[arr[i].role]);
//     }
// }
// printsummary(array);
...
//     pr.avatarUrl==undefined?console.log("The avatarURl is null"):console.log("The avatarURl is: ",pr.avatarUrl);
...
// // type Ordercallback = (status: Order)=> void;
...
for(let i = 0; i < transactions.length;i++){
    if(transactions[i].type === "checkout" || transactions[i].type === "return") totalprocessed++;
}

console.log(totalprocessed);
let i =0;
while(true){
    if(transactions[i].type == "priority") break;
    i++;
}
console.log(i);

let returnQueue: Transaction[] = [{ id: 1, type: "checkout" },{ id: 2, type: "cancelled" }];
let newReturns: Transaction[] = [{ id: 4, type: "priority" },{ id: 5, type: "checkout" }];

i = 0;

do {
  const item = newReturns[i];
